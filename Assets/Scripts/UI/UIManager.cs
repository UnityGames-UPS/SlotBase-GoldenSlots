...
public class UIManager : MonoBehaviour
{
    ...
    [SerializeField]
    private List<GameObject> m_Info_Objects;
    [SerializeField]
    private Button m_Info_Next_Button;
    [SerializeField]
    private Button m_Info_Prev_Button;
    [SerializeField]
    ...
    private void Start()
    {
        ...
        if (m_Info_Prev_Button) m_Info_Prev_Button.onClick.RemoveAllListeners();
        if (m_Info_Prev_Button) m_Info_Prev_Button.onClick.AddListener(delegate { InfoNavigation(false); });

        //Default Configuration Of The Info Next and Previous Button
